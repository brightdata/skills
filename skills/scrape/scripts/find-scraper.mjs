...
const USAGE_BLOCK = [
  ...
  '  -h, --help   this block',
  '',
  '  without --schema the output is a listing only. It does not say whether',
  '  a row can be triggered - that verdict, including "marketplace dataset,',
  '  not a scraper", comes from --schema.',
